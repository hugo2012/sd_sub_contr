sap.ui.define([
    ...
    FilterBar,ValueHelpDialog,TypeString,coreLibrary,Token) {
	"use strict";
    ...
    return  {
        createValueHelp: async function (config) {
            ...
            const dialogMetadata = {
                ...
                oControlF4Id: config.oControlF4Id,
                oContext: config.oContext
            }
                    ...
                    search: function (oEvent) {
                       ...
                       // if (filter.length > 0) {
                             if(dialogMetadata.modeQuery == 2)
                            {
                                 ...
                                 {
                                    case "idip_plant":
                                        dialogMetadata.oService.getPlantSet(filter).then(
                                            function (oData) {   
                                               // debugger;
                                                dialogMetadata.oModel.setProperty("/valueHelpSet", []);
                                    ...
                                    dialogMetadata.oService.getShippingPointSet(filter).then(
                                        function (oData) {   
                                           // debugger;
                                            dialogMetadata.oModel.setProperty("/valueHelpSet", []);
                                            dialogMetadata.oModel.setProperty("/valueHelpSet", oData.oData);
                                        ...
                                        break;
                                    case "idip_vendor":    
                                    dialogMetadata.oService.getVendorSet(filter).then(
                                        function (oData) {   
                                           // debugger;
                                            dialogMetadata.oModel.setProperty("/valueHelpSet", []);
                                            dialogMetadata.oModel.setProperty("/valueHelpSet", oData.oData);
                                    ...
                                    dialogMetadata.oService.getPONoSet(filter).then(
                                        function (oData) {   
                                           // debugger;
                                            dialogMetadata.oModel.setProperty("/valueHelpSet", []);
                                            dialogMetadata.oModel.setProperty("/valueHelpSet", oData.oData);
                                        ...
                                        dialogMetadata.oService.getWareHNoSet(filter).then(
                                            function (oData) {   
                                               // debugger;
                                                dialogMetadata.oModel.setProperty("/valueHelpSet", []);
                                                dialogMetadata.oModel.setProperty("/valueHelpSet", oData.oData);
                                            ...
                                            dialogMetadata.oService.getStorTypSet(filter).then(
                                                function (oData) {   
                                                   // debugger;
                                                    dialogMetadata.oModel.setProperty("/valueHelpSet", []);
                                                    dialogMetadata.oModel.setProperty("/valueHelpSet", oData.oData);
                                            ...
                                            dialogMetadata.oService.getStorBinSet(filter).then(
                                                function (oData) {   
                                                   // debugger;
                                                    dialogMetadata.oModel.setProperty("/valueHelpSet", []);
                                                    dialogMetadata.oModel.setProperty("/valueHelpSet", oData.oData);
                                            ...
                                            dialogMetadata.oService.getAssePrdSet(filter).then(
                                                function (oData) {   
                                                   // debugger;
                                                    dialogMetadata.oModel.setProperty("/valueHelpSet", []);
                                                    dialogMetadata.oModel.setProperty("/valueHelpSet", oData.oData);
                                                ...
                                                break;    
                                            case "idip_component":    
                                            dialogMetadata.oService.getCompoSet(filter).then(
                                                function (oData) {   
                                                   // debugger;
                                                    dialogMetadata.oModel.setProperty("/valueHelpSet", []);
                                                    dialogMetadata.oModel.setProperty("/valueHelpSet", oData.oData);
         ...
         createValueHelpConditionOnly: async function (e) {
            const t = {
                columnDefinition: e.columns,
                columns: {},
                filterId2ColId: {},
                modeQuery: e.modeQuery,
                keyFieldName: e.keyField,
                keyFieldName2: e.keyField2,
                oService: e.oService,
                entityName: e.entityName,
                oModel: e.model,
                labelDefinition: e.labelDefinition,
                columnName: e.columnDefiniton,
                inlineCount: e.inlineCount,
                _filterOperator: e._filterOperator
            };
            let l = await new ValueHelpDialog({
                draggable: false,
                title: e.title,
            ...
            if (e.dataType == "String") {
                l.setRangeKeyFields([{
                        ...
                        key: e.keyField,
                        type: "string",
                        typeInstance: new a({}, {maxLength: 20})
                    }])
            } else {
                l.setRangeKeyFields([{
                        label: e.title,
                        ...
                        typeInstance: new sap.ui.model.odata.type.DateTime(
                            {
                                pattern: "dd.MM.yyyy"
                            },
                            {maxLength: 20}
            ...
            if (t._filterOperator) {
                l.setConditionPanelDefaultOperation(t._filterOperator)
            } else {
                l.setConditionPanelDefaultOperation(sap.ui.comp.valuehelpdialog.ValueHelpRangeOperation.Contains)
            }
            return l
        },
